...
#SBATCH -t 0-45:00:00        ### The time limit in D-hh:mm:ss format
...
python /trinity/home/jyu/DeepSurvival/batch_scripts/MRI_SNP/Train_MRI_SNP_TFS_FS.py -n ${DATA} -i ${SPLIT}
