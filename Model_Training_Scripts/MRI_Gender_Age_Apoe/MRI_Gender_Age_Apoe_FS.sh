...
#SBATCH --nodelist=gpu005         ### How many GPUs do you need?
...
python /trinity/home/jyu/DeepSurvival/batch_scripts/MRI_Gender_Age_Apoe/Train_MRI_Gender_Age_Apoe_FS.py -n ${DATA} -i ${SPLIT}
