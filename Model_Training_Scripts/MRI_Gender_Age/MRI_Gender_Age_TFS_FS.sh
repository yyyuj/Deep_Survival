...
#SBATCH --nodelist=gpu005    ### which GPU to use
...
python /trinity/home/jyu/DeepSurvival/batch_scripts/MRI_Gender_Age/Train_MRI_Gender_Age_TFS_FS.py -n ${DATA} -i ${SPLIT}
