...
class LossHistory(keras.callbacks.Callback):
    ...
    def on_train_begin(self, logs={}):
        ...
        self.evolution_file = 'val_progress_pos_'+self.mv+'.csv'
        with open(MODEL_DIR+self.evolution_file, "w") as f:
            f.write('val_loss ; val_c\n')
        
        self.progress_file = 'training_progress_pos_'+self.mv+'.out'
...
def pretrained_model(input_shape):
    ...
    """
    model = tf.keras.models.load_model(MODEL_DIR+'model_MRI_Only_TFS_FS_'+str(int(args.i)+10)+'.h5', custom_objects={'CoxPH_loss': CoxPH_loss})
...
# In[60]:
version = 'MRI_Gender_Age_TFS_FS_'+args.i
